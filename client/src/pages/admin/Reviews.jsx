      ...
      "
                                    >
                                        <div className="flex flex-col xl:flex-row gap-5">
                                            ...
                                            {/* Customer */}
                                            <div className="flex gap-3 xl:w-[260px]">
                                                <img
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {/* Product Info Mobile */}
                                                <div className="flex items-center gap-3 mt-4 xl:hidden">
                                                    <img
                                            ...
                                            {/* Product Desktop */}
                                            <div className="hidden xl:flex items-center gap-3 w-[280px]">
                                                <img
                                                    src={review?.images?.[0]?.url}
                                                    alt=""
                                            ...
                                            {/* Date */}
                                            <div className="flex xl:block items-center justify-between xl:w-[120px]">
