...
import { addBlog, deleteBlog, getBlogs, getLatestBlogs, relatedBlogs, singleBlog, updateBlog } from '../controllers/blog.controller.js';
import isAdmin from '../middleware/isAdmin.js';
const router = express.Router();

router.post('/add', isAdmin, addBlog);
router.get('/get-blogs', getBlogs);
router.post('/related-blogs', relatedBlogs);
